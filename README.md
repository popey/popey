...
- [samber/cc-skills-golang](https://github.com/samber/cc-skills-golang) (1080) — 🧑‍🎨 A collection of Golang agentic skills that works
...
- [boshu2/agentops](https://github.com/boshu2/agentops) (263) — The bookkeeping layer for coding agents. Every session captures what it learned so the next one starts smarter.
