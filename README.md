...
- [samber/cc-skills-golang](https://github.com/samber/cc-skills-golang) (914) — 🧑‍🎨 A collection of Golang agentic skills that works
...
- [LerianStudio/ring](https://github.com/LerianStudio/ring) (156) — 89 skills and 38 specialized agents that enforce proven engineering practices for AI-assisted development. TDD, systematic debugging, parallel code review, and 10-gate development cycles — as a Claude Code plugin marketplace.
...
- [boshu2/agentops](https://github.com/boshu2/agentops) (236) — The missing DevOps layer for coding agents. Flow, feedback, and memory that compounds between sessions.
- [sundial-org/awesome-openclaw-skills](https://github.com/sundial-org/awesome-openclaw-skills) (540) — Top OpenClaw skills, with the most popular and useful ones.
