...
- [fix(gui): associate remote download progress with checkpoints](https://github.com/lemonade-sdk/lemonade/pull/3312) on [lemonade-sdk/lemonade](https://github.com/lemonade-sdk/lemonade) (1 day ago)
...
- [wimpysworld/sidra](https://github.com/wimpysworld/sidra) (477) — An elegant Apple Music desktop client for Linux, macOS and Windows. No frippery, just quality. A better class of Cider 🍎
- [samber/cc-skills-golang](https://github.com/samber/cc-skills-golang) (3057) — 🧑‍🎨 A collection of Golang agentic skills that works
