...
- [popey/toot-snap](https://github.com/popey/toot-snap) (5 days ago) — A snap of toot, the command line mastodon client
...
- [wimpysworld/sidra](https://github.com/wimpysworld/sidra) (13) — An elegant Apple Music desktop client for Linux, macOS and Windows. No frippery, just quality. A better class of Cider 🍎
...
- [samber/cc-skills-golang](https://github.com/samber/cc-skills-golang) (1097) — 🧑‍🎨 A collection of Golang agentic skills that works
...
- [LerianStudio/ring](https://github.com/LerianStudio/ring) (168) — 89 skills and 38 specialized agents that enforce proven engineering practices for AI-assisted development. TDD, systematic debugging, parallel code review, and 10-gate development cycles — as a Claude Code plugin marketplace.
...
- [boshu2/agentops](https://github.com/boshu2/agentops) (266) — The operational layer for coding agents. Memory, validation, and feedback loops that compound between sessions.
