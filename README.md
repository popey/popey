...
- [wimpysworld/sidra](https://github.com/wimpysworld/sidra) (86) — An elegant Apple Music desktop client for Linux, macOS and Windows. No frippery, just quality. A better class of Cider 🍎
- [tesslio/skill-review](https://github.com/tesslio/skill-review) (11) — A GitHub Action that automatically reviews SKILL.md files changed in a pull request and posts results as a PR comment
- [tesslio/setup-tessl](https://github.com/tesslio/setup-tessl) (3) — GitHub Action to install the Tessl CLI
- [samber/cc-skills-golang](https://github.com/samber/cc-skills-golang) (1680) — 🧑‍🎨 A collection of Golang agentic skills that works
